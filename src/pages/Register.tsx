    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden py-12 px-4 sm:px-6 lg:px-8">
      ...
      >
        <div className="text-center">
          ...
          <h2 className="text-3xl font-display font-bold text-foreground">Crea tu Cuenta</h2>
          <p className="mt-2 text-sm text-foreground/50">
            Únete a la red mesh más segura y privada del mundo.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-6">
          <div className="space-y-4">
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-foreground/70 mb-2 ml-1">Nombre de Usuario</label>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-foreground/70 mb-2 ml-1">Confirmar Contraseña</label>
                <div className="relative">
                  <span className="absolute left-4 top-1/2 -translate-y-1/2 text-white/20">
                    <Lock className="w-5 h-5" />
                  </span>
          ...
          <div className="flex items-center px-1">
            ...
            />
            <label htmlFor="terms" className="ml-2 block text-sm text-foreground/50">
              Acepto los <Link to="/terms" className="text-primary hover:underline transition-all">Términos de Servicio</Link> y la <Link to="/privacy" className="text-primary hover:underline transition-all">Política de Privacidad</Link>.
            </label>
          </div>
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-background text-foreground/40 uppercase tracking-widest font-bold text-[10px]">O regístrate con</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              type="button"
              className="flex items-center justify-center gap-3 py-4 px-4 bg-white/5 border border-white/10 rounded-2xl text-foreground hover:bg-white/10 transition-all font-medium"
            >
        ...
        <p className="mt-8 text-center text-sm text-foreground/50">
          ...
          <Link to="/login" className="font-bold text-primary hover:text-primary/80 transition-colors underline decoration-primary/30 underline-offset-4">
            Inicia sesión
          </Link>
        </p>
      </motion.div>
